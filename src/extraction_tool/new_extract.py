        ...
        for j in range(len(selected_questions[i])):
            ...
            for k in range(len(selected_questions[i][j])):
                if selected_questions[i][j][k] == "#":
                    ...
                    break
                if selected_questions[i][j][len(selected_questions[i][j])-1-k] == chr(34) and remove_last_quote == False:
                    #remove that quote 
                #print(selected_questions[i][j],len(selected_questions[i][j]) - len(selected_questions[i][j])-1-k)
                    if abs(len(selected_questions[i][j]) - len(selected_questions[i][j])-1-k) <=2:
                        selected_questions[i][j] = selected_questions[i][j][0 : len(selected_questions[i][j])-1-k]+ selected_questions[i][j][len(selected_questions[i][j])-1-k + 1 :len(selected_questions[i][j])]
